...
| **7. `aesthetic` (Thẩm mỹ & Văn phong)** | 0 - 100 | Văn phong có bị sáo rỗng, dính từ cấm AI (xem `anti_ai_tone.md`), từ lặp quá nhiều, hoặc lời thoại khô cứng không? | $< 60$: Nâng cấp thành **Polish** |
...
* **`accept` (Thông qua):**
  ...
  - Hợp đồng chương (`contract_status`) đạt `met` hoặc `fulfilled`.
* **`polish` (Trau chuốt):**
