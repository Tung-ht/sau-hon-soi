...
@page :left {
    @top-left {
        ...
        font-family: 'Be Vietnam Pro', 'Cinzel', sans-serif;
        font-size: 7.5pt;
        letter-spacing: 1px;
        color: #777;
    }
